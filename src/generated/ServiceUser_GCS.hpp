...
namespace muas
{
    ...
    public:
        ...
        void QuadRaster_Async(const std::vector<ndn::Name>& providers, const muas::WUAS_QuadRaster_Request &_request, muas::QuadRaster_Callback _callback,  const size_t strategy = ndn_service_framework::tlv::FirstResponding)
        {
            m_WUASServiceStub.QuadRaster_Async(providers, _request, _callback, strategy);
        }
        ...
        void GetMissionInfo_Async(const std::vector<ndn::Name>& providers, const muas::Mission_GetMissionInfo_Request &_request, muas::GetMissionInfo_Callback _callback,  const size_t strategy = ndn_service_framework::tlv::FirstResponding)
        {
            m_MissionServiceStub.GetMissionInfo_Async(providers, _request, _callback, strategy);
        }
        
        void GetItem_Async(const std::vector<ndn::Name>& providers, const muas::Mission_GetItem_Request &_request, muas::GetItem_Callback _callback,  const size_t strategy = ndn_service_framework::tlv::FirstResponding)
        {
            m_MissionServiceStub.GetItem_Async(providers, _request, _callback, strategy);
        }
        
        void SetItem_Async(const std::vector<ndn::Name>& providers, const muas::Mission_SetItem_Request &_request, muas::SetItem_Callback _callback,  const size_t strategy = ndn_service_framework::tlv::FirstResponding)
        {
            m_MissionServiceStub.SetItem_Async(providers, _request, _callback, strategy);
        }
        
        void Clear_Async(const std::vector<ndn::Name>& providers, const muas::Mission_Clear_Request &_request, muas::Clear_Callback _callback,  const size_t strategy = ndn_service_framework::tlv::FirstResponding)
        {
            m_MissionServiceStub.Clear_Async(providers, _request, _callback, strategy);
        }
        
        void Start_Async(const std::vector<ndn::Name>& providers, const muas::Mission_Start_Request &_request, muas::Start_Callback _callback,  const size_t strategy = ndn_service_framework::tlv::FirstResponding)
        {
            m_MissionServiceStub.Start_Async(providers, _request, _callback, strategy);
        }
        
        void Pause_Async(const std::vector<ndn::Name>& providers, const muas::Mission_Pause_Request &_request, muas::Pause_Callback _callback,  const size_t strategy = ndn_service_framework::tlv::FirstResponding)
        {
            m_MissionServiceStub.Pause_Async(providers, _request, _callback, strategy);
        }
        
        void Continue_Async(const std::vector<ndn::Name>& providers, const muas::Mission_Continue_Request &_request, muas::Continue_Callback _callback,  const size_t strategy = ndn_service_framework::tlv::FirstResponding)
        {
            m_MissionServiceStub.Continue_Async(providers, _request, _callback, strategy);
        }
        
        void Terminate_Async(const std::vector<ndn::Name>& providers, const muas::Mission_Terminate_Request &_request, muas::Terminate_Callback _callback,  const size_t strategy = ndn_service_framework::tlv::FirstResponding)
        {
            m_MissionServiceStub.Terminate_Async(providers, _request, _callback, strategy);
        }

...
main(int argc, char **argv)
{
    ...
    auto cap_call = [&]() {
        ...
        m_serviceUser.CaptureSingle_Async(iuas_providers, sensor_cap_request, [&, capture_start, time_req_sent](const muas::SensorCtrl_CaptureSingle_Response& _response) {
